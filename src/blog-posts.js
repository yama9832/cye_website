...
export const posts = [
  {
    ...
    images: [],
    content: `
    <p>2025年7月20日投開票の参議院選挙が実施されます。</p>
    <p>自由山間党、自由ヤンマシア解放戦線、山間民主党、山間勇者の会、やんまーから国民を守る党、やんま新鮮組、山間保守党などが候補者を擁立すると見込まれます。</p>
    <p>投票日に投票所へ行けない方は期日前投票や不在者投票を、仕事や留学で海外にお住いの方は在外投票ができます。</p>
    `
  },
  {
